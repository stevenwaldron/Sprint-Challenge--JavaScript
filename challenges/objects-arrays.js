...
*/
const displayNames = [];
zooAnimals.forEach(i => displayNames.push(`${i.animal_name}, ${i.scientific_name}`));
...
const lowCaseAnimalNames = [];
 let x = zooAnimals.map(i => i.animal_name.toLowerCase())
 x.forEach(i => lowCaseAnimalNames.push(i))
...
let y = zooAnimals.filter(i => i.population < 5)
y.forEach(i => lowPopulationAnimals.push(i))
